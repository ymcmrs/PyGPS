...
INTRODUCTION = '''Download GPS zenith wet delay data for every SAR acquisitions.
    
'''

EXAMPLE = '''EXAMPLES:
    download_gps_atm_all.py projectName
    download_gps_atm_all.py LosAngelesT71F479S1D
...
def main(argv):
    ...
    call_str = 'download_gps_atm.py ' + Search_GPS + ' --datetxt ' + datelist_txt
    os.system(call_str)
