...
EXAMPLE = '''EXAMPLES:
    ...
    ztd2los.py DATE
    ztd2los.py DATE --station station
    ztd2los.py DATE --station_txt search_gps.txt
    
    ztd2los.py 20150101 --station BGIS
    ztd2los.py 20150101 --station_txt search_gps_inside.txt
'''    
