...
def cmdLineParse():
    ...
    parser.add_argument('h5_file', help='Get SAR coverage based on PYSAR interferograms h5 file.')
...
def main(argv):
    ...
    LAT4=f_h5[k1][k2[i]].attrs['LAT_REF4']
        
    LON1=f_h5[k1][k2[i]].attrs['LON_REF1']
    LON2=f_h5[k1][k2[i]].attrs['LON_REF2']
    LON3=f_h5[k1][k2[i]].attrs['LON_REF3']
    LON4=f_h5[k1][k2[i]].attrs['LON_REF4']
    
   
    LAT_REF = [LAT1,LAT2,LAT3,LAT4]
    LON_REF = [LON1,LON2,LON3,LON4]
    call_str = 'echo ' + LON_REF[0] + ' ' + LAT_REF[0] + ' >>' + TXT
    os.system(call_str)
        
    call_str = 'echo ' + LON_REF[1] + ' ' + LAT_REF[1] + ' >>' + TXT
    os.system(call_str)
        
    call_str = 'echo ' + LON_REF[3] + ' ' + LAT_REF[3] + ' >>' + TXT
    os.system(call_str)
        
    call_str = 'echo ' + LON_REF[2] + ' ' + LAT_REF[2] + ' >>' + TXT
    os.system(call_str)
